...
#  Cubiezz for cubieboard A10 kernel 3.4.43 (tested)
#  Cubiezz for cubieboard A20 kernel 3.4.43
# 
#  U-Boot source:
#
...
if promptyn "Install bootloader, [y] to continue [n] to skip this step"; then
...
if promptyn "Install rootfs, [y] to continue [n] to skip this step"; then
    mountDevice
